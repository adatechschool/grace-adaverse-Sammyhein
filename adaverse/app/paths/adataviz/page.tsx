...
export default async function Adataviz(){

    const [projects] = await db.select().from(adaProjects).where(eq(adaProjects.title, "Adataviz"))
    ...
    return(
        ...
        mb-5">Projet<span className="ml-2 text-(--color-logo)">Adataviz</span></h1>
